...
1. **v0: Bash is All You Need** (~150行)
   - 最简 Agent 实现
   - 只有 1 个工具：bash
   - 理解 Agent 的本质

2. **v1: Model as Agent** (~320行)
   - 4 个基础工具
   - Agent Loop 模式
   - 安全防护机制
...
- [示例教程](examples/README.md) - 渐进式学习路径
