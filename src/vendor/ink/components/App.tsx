...
import { updateLastInteractionTime } from '../shims/bootstrap-state.js';
import { logForDebugging } from '../shims/debug.js';
import { stopCapturingEarlyInput } from '../shims/earlyInput.js';
import { isEnvTruthy } from '../shims/envUtils.js';
import { isMouseClicksDisabled } from '../shims/fullscreen.js';
import { logError } from '../shims/log.js';
